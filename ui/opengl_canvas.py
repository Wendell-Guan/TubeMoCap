"""
Copied from https://github.com/Arkueid/live2d-py/blob/main/package/main_pyqt5_canvas_opacity.py
"""
...
def create_vbos(v_pos, uv_coord):
...
class OpenGLCanvas(QOpenGLWidget):
    ...
    def __create_program(self):
        ...
        void main() {
            vec4 color = texture2D(canvas, v_texCoord);
            color *= opacity;
            gl_FragColor = color;
        }
        """
    ...
    def paintGL(self):
        ...
        GL.glUniform1f(self._opacity_loc, self.__canvas_opacity)
