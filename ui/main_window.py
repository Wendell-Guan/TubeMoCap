...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self._face_status = QLabel('Face: ○ Not Connected')
        self._body_status = QLabel('Body: ○ Not Connected')
    ...
    def _build_menu(self):
        ...
        act_open = QAction('Open Dataset Directory…', self)
